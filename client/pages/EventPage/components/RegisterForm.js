...
i
  ...
  render() {
    ...
    const { errors, isFormValid, isSubmitted, showConfirmationModal } =
      this.state;
          ...
          <div className={styles.registerModal}>
            ...
            <div className={styles.checkbox}>
              ...
              <label htmlFor="newsletter">
                I agree to receive communications and newsletters.
              </label>
            </div>
            <div className={styles.terms}>
              By proceeding, you agree to our{" "}
              <a href="/terms">Terms of Service</a> and confirm you have read
              our <a href="/privacy">Privacy Policy</a>.
            </div>
            <button
              onClick={this.handleSubmit}
              className={isFormValid ? `${PRIMARY}` : `${TERTIARY}`}
              style={{
                width: "100%",
                cursor: "pointer",
                height: "60px",
